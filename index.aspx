...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text text-center">Looking for a child-centred, activity-based literacy program? Discover
    ...
    <section class="latest-news">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12">
            <div class="article-image ripple" data-mdb-ripple-color="light" data-aos="fade-up" data-aos-duration="1200">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="owl-carousel owl-theme newspaper">
              <div class="item"><img src="img/newspaper/My-City-Hindi-18_June_2023.jpg" alt="" class="img-fluid"></div>
            ...
            <div class="owl-carousel owl-theme videos">
              <div class="item">
                <iframe class="elementor-video" frameborder="0" allowfullscreen=""
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  title="नन्हे-मुन्नों की फर्राटेदार अंग्रेजी-हिन्दी सुनकर चौंक जाएंगे आप! @ImageTodayNews" width="100%"
                  height="166"
